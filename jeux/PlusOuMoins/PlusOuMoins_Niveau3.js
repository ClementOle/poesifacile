...
if (isNaN(nombreJoueur)){
	...
	while((nombreJoueur != nombreAleatoire ) && (nbTentatives < 2) && estUnEntier == true){
		...
		if((nombreJoueur == nombreAleatoire) && (estUnEntier == true)){
			...
			sessionStorage.setItem("pointsGagnesNiveau3", 1);
			sessionStorage.setItem("pointsPerdusNiveau3", 0);
			sessionStorage.setItem('nbTentatives3',nbTentatives);
			...
			continuerPartie = true;
			sessionStorage.setItem("pointsPerdusNiveau3", 0);
			sessionStorage.setItem("pointsGagnesNiveau3", 0);
			sessionStorage.setItem('nbTentatives3',nbTentatives);
		}
