...
<head>
	<meta charset="UTF-8">
	<link rel="stylesheet" type="text/css" href="PlusOuMoins_Niveau1.css">
	<title>Jeu du Plus ou Moins</title>
</head>
<body>
	<main>
		<div>
			<h1>Jeu du Plus ou Moins - Niveau 1</h1>
			<div class="bandeau">
				<div class="Regles">Règles du jeu</div>
				<div class="choixMusique">&#9835; Un peu de musique &#9835;?</div>
				<div class="pisteAudio"></div>
			</div>
			<p> L'ordinateur a généré un nombre aléatoire entre 0 et 100. Tentez de deviner ce nombre. Vous avez droit à 6 tentatives!</p>
		</div>
...
<div class="continuerPartieOuPas" style="display: none">
	<a href="PlusOuMoins_Niveau2.php" id="lienNiveau2">Cliquez ici pour accéder au <br> niveau 2</a>

</div>
</main>
	<script type="text/javascript" src="PlusOuMoins_Niveau1.js"></script>
</body>
</html>