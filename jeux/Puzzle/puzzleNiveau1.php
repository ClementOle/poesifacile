...
<head>
	<meta charset="UTF-8">
	<link rel="stylesheet" type="text/css" href="puzzleNiveau1.css">
	<title>Jeu du Puzzle</title>
</head>

<body>
	<h1>Jeu du Puzzle Numéro 1</h1>
	<h2>Règle du jeu : </h2>
...
<p class="lienNiveauSuivant" style="display: none"><a href="puzzleNiveau2.php">Cliquez ici pour accéder au <br> niveau 2</a></p>
<footer class="footer"> 
<p>POE si facile! ©2018 </p>
</footer>

	<script type="text/javascript" src="puzzleNiveau1.js"></script>
</body>
</html>
