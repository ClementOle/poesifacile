...
function init() {
    ...
    img4.src = "images/logo4.png";
    img5.src = "images/logo5.png";
    img6.src = "images/logo6.png";
    img7.src = "images/logo7.png";
    img8.src = "images/logo8.png";
    img9.src = "images/logo9.png";
    ...
    if ((case1.firstElementChild.classList.contains('s1')) 
        ...
        let message = document.createElement('p');
            msg.appendChild(message);
                ...
                soldeTotalNiveau1 = 1;
                console.log('est passé dans Bravo');
        ...
        let message = document.createElement('p');
                ...
                soldeTotalNiveau1 = 0;
                console.log('est passé dans Perdu');
                document.querySelector('.lienNiveauSuivant').style.display = 'block';
    }
    console.log('soldeTotalNiveau1 avant parseInt vaut : ' + soldeTotalNiveau1);
    sessionStorage.setItem('pointsNiveau1', parseInt(soldeTotalNiveau1));
    console.log('après le parseInt : ' + soldeTotalNiveau1);
});
