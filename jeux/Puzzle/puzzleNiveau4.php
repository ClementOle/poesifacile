...
<head>
	<meta charset="UTF-8">
	<link rel="stylesheet" type="text/css" href="puzzleNiveau4.css">
	<title>Jeu du Puzzle</title>
</head>

<body>
	<h1>Jeu du Puzzle Numéro 4</h1>
	<h2>Règle du jeu : </h2>
	<p>Vous devez réaliser le puzzle en glissant les pièces vers leurs emplacements final afin de reconstruire le puzzle, puis cliquez sur valider quand vous avez fini.</p>
...
<button class="buttonValider">Valider</button>
	<button class="buttonReset"><a href="javascript:window.location.reload()" class="reset" onclick="boutonReset()">Reset</a></button>

<div class="msg">

</div>
<p class="lienNiveauSuivant" style="display: none"><a href="eval_JS.php">Lien vers l'évaluation</a></p>
<footer class="footer"> 
<p>POE si facile! ©2018 </p>
</footer>
	<script type="text/javascript" src="puzzleNiveau4.js"></script>
</body>
</html>
