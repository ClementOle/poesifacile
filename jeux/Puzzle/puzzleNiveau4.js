...
function init() {
    ...
    img2.src = "images/info2.png";
    img3.src = "images/info3.png";
    img4.src = "images/info4.png";
    img5.src = "images/info5.png";
    img6.src = "images/info6.png";
    img7.src = "images/info7.png";
    img8.src = "images/info8.png";
    img9.src = "images/info9.png";
    img10.src = "images/info10.png";
    img11.src = "images/info11.png";
    img12.src = "images/info12.png";
    img13.src = "images/info13.png";
    img14.src = "images/info14.png";
    img15.src = "images/info15.png";
    img16.src = "images/info16.png";
...
function boutonReset() {
    ...
    console.log('fonction boutonReset, soldeNegatif vaut : ' + soldeNegatif);
}
...
buttonValider.addEventListener('click', function(event) {
    if ((case1.firstElementChild.classList.contains('s1')) 
        ...
        let message = document.createElement('p');
            msg.appendChild(message);
                ...
                sessionStorage.setItem("pointGagneNiveau4", 1);
                sessionStorage.setItem("pointPerduNiveau4", 0);
    ...
    soldeTotalNiveau4 = parseInt(soldePointsDepart) + parseInt(soldeNegatif);
    console.log('soldePointsDepart vaut : ' + parseInt(soldePointsDepart));
    console.log('soldeNegatif vaut : ' + parseInt(soldeNegatif));
    console.log('soldeTotalNiveau4 vaut : ' + parseInt(soldeTotalNiveau4));
    sessionStorage.setItem('pointsNiveau4', parseInt(soldeTotalNiveau4));
});
